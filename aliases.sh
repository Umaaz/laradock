...
alias composer='docker exec --user=laradock laradock_workspace_1 composer --working-dir=/var/www/${PWD:${#REPO_DIR}}'
alias php='docker exec --workdir=/var/www/${PWD:${#REPO_DIR}} --user=laradock laradock_workspace_1 php'
